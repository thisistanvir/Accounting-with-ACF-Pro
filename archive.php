  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?php echo esc_url(home_url('/')) ?>"><?php echo esc_html__('Home', 'accounting'); ?> <i class="fa fa-arrow-right"></i></a></span> <span> <?php the_archive_title(); ?></span></p>
